...
Based on upstream release `v1.19.5` (the `stable-1.19.x` line).

This branch carries an opt-in profiling patch for cang launch diagnosis:
...
- Profile diagnostics: cang can append kernel logging flags only for profiled
